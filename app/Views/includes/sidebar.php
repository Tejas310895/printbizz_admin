...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="/"><img src="<?= base_url() ?>public/lab_themes/assets/images/profile_av.jpg" alt="User"></a>
                    <div class="detail">
                        <h4>Akash</h4>
...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        <li><a href="settings" class="js-right-sidebar" title="Setting"><i class="zmdi zmdi-settings zmdi-hc-spin"></i></a></li>
